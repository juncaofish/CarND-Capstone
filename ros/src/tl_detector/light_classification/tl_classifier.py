...
class TrafficLightClassifier:
    ...
    def __init__(self, input_shape, learning_rate, verbose=True):
        ...
        self.n_classes = 4  # {none, red, yellow, green}
...
class TLClassifier:
    ...
    def __init__(self, input_shape, checkpoint_path):
        ...
        self.classifier = TrafficLightClassifier(input_shape, learning_rate=1e-4)
    ...
    def get_classification(self, image):
        ...
        x_batch = np.expand_dims(preprocess(image), 0)
        prediction = self.sess.run(fetches=self.classifier.inference,
                                   feed_dict={self.classifier.x: x_batch, self.classifier.keep_prob: 1.})
